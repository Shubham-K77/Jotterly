...
const LifeCraft = () => {
  ...
  return (
    ...
    >
      ...
      {/* Categories */}
      <Categories categoryCount={categoryCount} category={"LifeCraft"} />
      {/* Banner Image */}
      <Banner
        image={`/Images/lifeBanner.jpg`}
        desc={
          "LifeCraft – A vibrant space to organize your life’s adventures, from family moments to travel, planning, and personal growth, helping you shape your journey."
        }
      />
