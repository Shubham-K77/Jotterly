...
const IdeaBox = () => {
  ...
  return (
    ...
    >
      ...
      {/* Categories */}
      <Categories categoryCount={categoryCount} category={"IdeaBox"} />
      {/* Banner Image */}
      <Banner
        image={`/Images/ideaBanner.jpg`}
        desc={
          "IdeaBox – The creative vault for capturing and organizing brilliant ideas, brainstorming sessions, and innovative thoughts in one place."
        }
      />
